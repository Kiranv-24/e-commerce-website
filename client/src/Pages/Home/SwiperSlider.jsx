...
const SwiperSlider = () => {
  ...
  const [selectedProduct, setSelectedProduct] = useState(null);
    ...
    const filteredProducts = productquery && productquery.trim() !== ""
    ...
    return (
        <div className="Product_row">
            ...
            <Swiper
                key={swiperKey}
                slidesPerView={filteredProducts.length < 6 ? filteredProducts.length : 5}
                spaceBetween={0}
                navigation={true}
                modules={[Navigation]}
                className="mySwiper"
            ...
            >
                {(filteredProducts.length > 0 ? filteredProducts : proData)?.map((product, index) => (
